...
class NewVisitorTest(unittest.TestCase):
    ...
    # setUp — это часть инициализации, этот метод будет вызываться перед
    # каждым методом теста, который вы собираетесь написать внутри класса
    # теста. Здесь мы создаем элемент класса Firefox WebDriver.
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # self.fail ничего не получилось, генерирует сообщение об ошибке.
        # Используется в качестве напоминания, чтобы закончить тест.
